...
class UtilsMixin(UtilsFilteredTenantsMixin):
    ...
    @cached_property
    def _vtep(self) -> bool:
        return get(self._hostvars, "switch.vtep", required=True) is True
    ...
    @cached_property
    def _vrf_default_ipv4_static_routes(self) -> list[str]:
        """
        Return list of ipv4 static routes in VRF "default"
        """
        ...
        return list(vrf_default_ipv4_static_routes)
    ...
    @cached_property
    def _mpls_ler(self) -> bool:
        return get(self._hostvars, "switch.mpls_ler") is True
