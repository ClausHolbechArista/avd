...
class RouterBgpMixin(UtilsMixin):
    ...
    def _address_family_evpn(self) -> list:
        ...
        if self._overlay_dpath is True:
            address_family_evpn["domain_identifier"] = get(self.shared_utils.switch_data_combined, "ipvpn_gateway.evpn_domain_id", default="0:1")
    ...
    def _address_family_vpn_ipvx(self, version: int) -> list | None:
        ...
        if self._overlay_dpath is True:
            address_family_vpn_ipvx["domain_identifier"] = get(self.shared_utils.switch_data_combined, "ipvpn_gateway.ipvpn_domain_id", default="0:2")
