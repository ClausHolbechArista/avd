...
| ------- | -------- | ---------- | ----- |
| example@example.com | MPLS_CORE SITE1-LER1 | All | Disabled |
...
snmp-server location MPLS_CORE SITE1-LER1
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet8 | CPE_TENANT_A_SITE1_Ethernet1 | *trunk | *10 | *- | *- | 8 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | CPE_TENANT_A_SITE1_EVPN-A-A-PortChannel | switched | trunk | 10 | - | - | - | - | - | 0000:0000:0303:0202:0101 |
