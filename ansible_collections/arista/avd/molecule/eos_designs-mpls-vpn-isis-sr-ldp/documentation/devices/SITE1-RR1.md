...
| ------- | -------- | ---------- | ----- |
| example@example.com | MPLS_CORE SITE1-RR1 | All | Disabled |
...
snmp-server location MPLS_CORE SITE1-RR1
```
...
| 100.70.0.9 | Inherited from peer group RR-OVERLAY-PEERS | default | Inherited from peer group RR-OVERLAY-PEERS | Inherited from peer group RR-OVERLAY-PEERS | - |
