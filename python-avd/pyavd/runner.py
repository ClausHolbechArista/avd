...
from eos_cli_config_gen import run_eos_cli_config_gen
from eos_designs_facts import run_eos_designs_facts
from eos_designs_structured_configs import run_eos_designs_structured_configs
from template_var_files import run_template_var_files
...
def main():
    ...
    if args.template_vars:
        run_template_var_files(args.common_varfile, args.device_varfiles, args.verbose)

    if args.eos_designs_facts:
        run_eos_designs_facts(args.common_varfile, args.device_varfiles, args.factsfile, args.verbose)

    if args.eos_designs_structured_configs:
        run_eos_designs_structured_configs(args.common_varfile, args.factsfile, args.device_varfiles, args.struct_cfgfiles, args.verbose)

    if args.eos_cli_config_gen:
        run_eos_cli_config_gen(args.common_struct_cfgfile, args.struct_cfgfiles, args.cfgfiles, args.docfiles, args.verbose)
